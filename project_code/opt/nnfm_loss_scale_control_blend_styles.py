            ...
            for block in blocks_style_coarse:
                ...
                if "nnfm_loss" in loss_names:
                    ...
                    if epoch_id < 7:
                        ...
                        loss_dict["nnfm_loss"] = loss_dict["nnfm_loss"] +  cos_loss(x_feats_coarse, target_feats) * 0.2
        ...
        if epoch_id >= 7:
            for block in blocks_style_fine:
                ...
                if "nnfm_loss" in loss_names:
                    ...
                    loss_dict["nnfm_loss"] = loss_dict["nnfm_loss"] + cos_loss(x_feats_fine, target_feats) * 0.8
