...
class NNFMLoss(torch.nn.Module):
    ...
    def forward(
        ...
        blocks_style_fine = [0, 1] #[2]
        blocks_style_fine_weight = [0.3, 1.7] # [0.3, 1.7] more fine style
        ...
        if True: # calculate fine style
            ...
            for index, block in enumerate(blocks_style_coarse):
                ...
                if "nnfm_loss" in loss_names:
                    ...
                    loss_dict["nnfm_loss"] = loss_dict["nnfm_loss"] +  cos_loss(x_feats_coarse, target_feats) * 3 / len(blocks_style_coarse) * blocks_style_coarse_weight[index]
        ...
        if True: # calculate coarse style
            ...
            # for block in blocks_style_fine:
                ...
                if "nnfm_loss" in loss_names:
                    ...
                    loss_dict["nnfm_loss"] = loss_dict["nnfm_loss"] + cos_loss(x_feats_fine, target_feats) * 3 / len(blocks_style_fine) * blocks_style_fine_weight[index]
