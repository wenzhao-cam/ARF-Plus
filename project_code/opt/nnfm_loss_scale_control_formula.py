...
class NNFMLoss(torch.nn.Module):
    ...
    def forward(
        ...
        outputs,
        styles,
        style_vgg_layer_weight='0-0-1-0-0',
        blocks=[
            2,
        ],
        ...
        if False: # resize the style image
        ...
        print('style_vgg_layer_weight', style_vgg_layer_weight)
        ...
        blocks_style_weight = style_vgg_layer_weight.split('-')
        blocks_style_weight = [float(item) for item in blocks_style_weight]
        print('blocks_style_weight', blocks_style_weight)

        style_img_scales = style_img_scales.split('-')
        style_img_scales = [float(item) for item in style_img_scales]
