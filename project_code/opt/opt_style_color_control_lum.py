...
from nnfm_loss_color_control_luminance import NNFMLoss, match_colors_for_image_set
...
if not args.no_pre_ct:
    ...
    # comment out for preserve color
    # dset.rays.gt, color_tf = match_colors_for_image_set(dset.rays.gt, style_img)
    # preserve color 
    # dset.rays.gt, color_tf = match_colors_for_image_set(dset.rays.gt, dset.rays.gt)
        ...
        for iter_id, batch_begin in pbar:
            ...
            if optim_type == "ray":
                ...
                def compute_image_loss():
                    ...
                    # loss_dict["nnfm_loss"] *= 10                   
                    # if epoch_id < 5:
                    #     loss_dict["content_loss"] *= args.content_weight
                    # else: 
                    #     loss_dict["content_loss"] *= args.content_weight * 2
