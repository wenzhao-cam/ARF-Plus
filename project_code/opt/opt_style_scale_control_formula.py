...
from nnfm_loss_scale_control_formula import NNFMLoss, match_colors_for_image_set
...
parser.add_argument("--style_img_scales", type=str, default='1-1-1-1-1', help="scale value for style img for each layers fine-tune for scale control")
parser.add_argument("--style_vgg_layer_weight", type=str, default='0-0-1-0-0', help="vgg style layer weights for scale control")
parser.add_argument(
    "--vgg_block",
    type=int,
    default=2,
            ...
            if optim_type == "ray":
                ...
                def compute_image_loss():
                    ...
                    loss_dict = nnfm_loss_fn(
                        ...
                        style_vgg_layer_weight=args.style_vgg_layer_weight,
                        style_img_scales=args.style_img_scales,
                    )
