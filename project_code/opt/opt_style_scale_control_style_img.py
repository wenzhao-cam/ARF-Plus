...
from nnfm_loss_scale_control_style_img import NNFMLoss, match_colors_for_image_set
...
parser.add_argument("--style_vgg_layer", type=str, default='2', help="vgg style layer index for scale control")
parser.add_argument(
    "--vgg_block",
    type=int,
    default=2,
