            ...
            if optim_type == "ray":
                ...
                def compute_image_loss():
                    with torch.no_grad():
                        ...
                        # print('ablation saved_rgb_pred.shape', rgb_pred.shape)
                        # print('ablation saved_rgb_gt.shape', rgb_gt.shape)
                    ...
                    # rgb_pred *= semantic_mask
                    # rgb_gt *= semantic_mask
                    rgb_pred_copy=F.interpolate(
                            rgb_pred,
                            size=None,
                            scale_factor=1,
                            mode="bilinear",
                        )
                    contents_copy = rgb_gt
                    # contents_copy=F.interpolate(
                    #         rgb_gt,
                    #         size=None,
                    #         scale_factor=1,
                    #         mode="bilinear",
                    #     ),
                    # print('ablation rgb_pred copy  shape', rgb_pred_copy.shape)
                    # print('rgb_pred_copy shape', rgb_pred_copy.shape)
                    if True:
                        rgb_pred_copy *= semantic_mask
                        # print('rgb_pred_copy shape', rgb_pred_copy.shape)
                        # print('contents_copy shape', contents_copy.shape)
                        contents_copy = rgb_gt * semantic_mask
                    # print('contents_copy shape', contents_copy.shape)
                    # reshape_semantic_mask = F.interpolate(
                    #         semantic_mask,
                    #         size=None,
                    #         scale_factor=0.5,
                    #         mode="bilinear",
                    #     )
                    # print('ablation reshape_semantic_mask shape', reshape_semantic_mask.shape)
                    ...
                    if False: #True
                        # rgb_pred.grad *= mask
                        print('ablation study semantic mask shape', semantic_mask.shape)
