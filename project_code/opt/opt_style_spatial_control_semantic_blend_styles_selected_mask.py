    ...
    def train_step(optim_type):
        ...
        for iter_id, batch_begin in pbar:
            ...
            if optim_type == "ray":
                ...
                # add by wenzhao - 05-24
                # selected not perfect view mask
                num_view_imgs = num_views # 8

                # img_id = np.random.randint(low=0, high=num_view_imgs)
                # img_id = np.random.randint(low=120, high=124)
                img_id = random.choice([15, 16, 17, 18, 19, 37, 49, 81, 120, 121, 122, 123, 124])
                rays = svox2.Rays(
