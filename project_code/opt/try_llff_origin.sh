...
# ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE}_depth_control
...
# python opt_style_test_MiDaS_depth.py -t ${ckpt_arf} ${data_dir} \
#                 -c configs/llff_fixgeom.json \
#                 --init_ckpt ${ckpt_svox2}/ckpt.npz \
#                 --style ${style_img} \
#                 --mse_num_epoches 2 --nnfm_num_epoches 10 \
#                 --content_weight 1e-3 --depth_weight 2e-3

python render_imgs.py ${ckpt_svox2} ${data_dir} \
                    --render_path
