...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_scale_control_one_loss_lum
...
python opt_style_scale_control_blend_styles_one_loss_func_lum.py -t ${ckpt_arf} ${data_dir} \
...
# --mse_num_epoches 1 --nnfm_num_epoches 5 \
#                 --content_weight 5e-4 --disable_recolor 1