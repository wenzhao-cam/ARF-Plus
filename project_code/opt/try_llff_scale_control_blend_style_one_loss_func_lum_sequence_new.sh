...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_newnew_wacv_blend_scale_control_one_loss_lum_sequence_new
...
python opt_style_scale_control_blend_styles_one_loss_func_lum_sequence_new.py -t ${ckpt_arf} ${data_dir} \
...
# --content_weight 1e-4 --disable_recolor 1