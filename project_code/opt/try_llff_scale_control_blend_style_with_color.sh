...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_color_scale_control_with_color
...
python opt_style_scale_control_blend_styles_with_color.py -t ${ckpt_arf} ${data_dir} \
