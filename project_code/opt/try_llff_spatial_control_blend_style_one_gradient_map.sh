...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_spatial_control_one_gradient_map
...
python opt_style_spatial_control_blend_styles_one_gradient_map.py -t ${ckpt_arf} ${data_dir} \
