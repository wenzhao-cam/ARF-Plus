...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_revert_origin_content_mask
...
python opt_style_spatial_control_blend_styles_revert_origin_content_mask.py -t ${ckpt_arf} ${data_dir} \
