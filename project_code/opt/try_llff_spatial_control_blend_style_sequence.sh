...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_spatial_control_sequence_05_24
...
python opt_style_spatial_control_blend_styles_sequence.py -t ${ckpt_arf} ${data_dir} \
