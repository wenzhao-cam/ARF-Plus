...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE}_spatial_control_reverse
...
python opt_style_spatial_control_reverse.py -t ${ckpt_arf} ${data_dir} \
                -c configs/llff_fixgeom.json \
                --init_ckpt ${ckpt_svox2}/ckpt.npz \
                --style ${style_img} \
                --mse_num_epoches 2 --nnfm_num_epoches 4 \
                --content_weight 1e-3 
...
# other spatial control --nnfm_num_epoches 4 \
# blend spatial control --nnfm_num_epoches 10 \