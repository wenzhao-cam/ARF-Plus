...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_spatial_control_semantic_blend_revert_origin_content_mask_new
...
python opt_style_spatial_control_semantic_blend_styles_revert_origin_content_mask.py -t ${ckpt_arf} ${data_dir} \
