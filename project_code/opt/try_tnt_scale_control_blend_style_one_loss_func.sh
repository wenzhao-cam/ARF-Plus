...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE1}_${STYLE2}_blend_scale_control_one_loss
...
python opt_style_scale_control_blend_styles_one_loss_func.py -t ${ckpt_arf} ${data_dir} \
