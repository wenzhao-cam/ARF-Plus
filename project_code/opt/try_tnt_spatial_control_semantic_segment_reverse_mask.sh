...
ckpt_arf=ckpt_arf/${data_type}/${SCENE}_${STYLE}_spatial_control_semantic_segment_reverse_mask
...
python opt_style_spatial_control_semantic_reverse_mask.py -t ${ckpt_arf} ${data_dir} \
